...
HD_PWD='C:/Users/95223/Desktop/course_design/course_design.runs/ip_iram_dual_port_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_iram_dual_port.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip_iram_dual_port.tcl
